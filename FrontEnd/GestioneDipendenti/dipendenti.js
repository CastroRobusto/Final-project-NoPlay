...
function modificaPersonale(idDipendente){
  ...
  $.get(`personale/${idDipendente}`, function(res){
      ...
      $('#modifica-personale').on('click', '#invia-modifica-personale', function(){
          //const id = idDipendente;//res.object.id;
          ...
          console.log('riavvio put ' + idDipendente);
          
          const dipendenteMod = {idDipendente, nome, cognome, ddn, stipendio, dataAssunzione, idAzienda, idRuolo};
          console.log(dipendenteMod);
